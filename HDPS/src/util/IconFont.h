...
public: // Getters
     ...
     */
    QIcon getIcon(const QString& name, const QSize& size = QSize(14, 14), const QColor& foregroundColor = QColor(0, 0, 0, 255), const QColor& backgroundColor = Qt::transparent) const;
