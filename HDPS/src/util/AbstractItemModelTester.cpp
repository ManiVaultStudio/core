...
AbstractItemModelTester::AbstractItemModelTester(QAbstractItemModel *_model, QObject *parent) : QObject(parent), model(_model)
{
    ...
    connect(model, &QAbstractItemModel::columnsAboutToBeInserted,
            this, &AbstractItemModelTester::runAllTests);
    ...
    connect(model, &QAbstractItemModel::headerDataChanged,
            this, &AbstractItemModelTester::runAllTests);
    connect(model, &QAbstractItemModel::layoutAboutToBeChanged, this, &AbstractItemModelTester::runAllTests);
    connect(model, &QAbstractItemModel::layoutChanged, this, &AbstractItemModelTester::runAllTests);
    connect(model, &QAbstractItemModel::modelReset, this, &AbstractItemModelTester::runAllTests);
    ...
    connect(model, &QAbstractItemModel::layoutAboutToBeChanged,
            this, &AbstractItemModelTester::layoutAboutToBeChanged);
    connect(model, &QAbstractItemModel::layoutChanged,
            this, &AbstractItemModelTester::layoutChanged);

    connect(model, &QAbstractItemModel::rowsAboutToBeInserted,
            this, &AbstractItemModelTester::rowsAboutToBeInserted);
    connect(model, &QAbstractItemModel::rowsAboutToBeRemoved,
            this, &AbstractItemModelTester::rowsAboutToBeRemoved);
    connect(model, &QAbstractItemModel::rowsInserted,
            this, &AbstractItemModelTester::rowsInserted);
    connect(model, &QAbstractItemModel::rowsRemoved,
            this, &AbstractItemModelTester::rowsRemoved);

    runAllTests();
}

void AbstractItemModelTester::runAllTests()
{
    if (fetchingMore)
        return;
...
*/
void AbstractItemModelTester::nonDestructiveBasicTest()
{
 ...
 */
void AbstractItemModelTester::rowCount()
{
    // check top row
 ...
 */
void AbstractItemModelTester::columnCount()
{
    // check top row
    QModelIndex topIndex = model->index(0, 0, QModelIndex());
 ...
 */
void AbstractItemModelTester::hasIndex()
{
 ...
 */
void AbstractItemModelTester::index()
{
    // Make sure that invalid values returns an invalid index
 ...
 */
void AbstractItemModelTester::parent()
{
 ...
 */
void AbstractItemModelTester::checkChildren(const QModelIndex &parent, int currentDepth)
{
    QModelIndex tmp;
 ...
 */
void AbstractItemModelTester::data()
{
...
/*!
    ...
    \sa rowsInserted()
 */
void AbstractItemModelTester::rowsAboutToBeInserted(const QModelIndex &parent, int start, int end)
{
    Q_UNUSED(end)
    Changing c;
    c.parent = parent;
 ...
 */
void AbstractItemModelTester::rowsInserted(const QModelIndex & parent, int start, int end)
{
...
void AbstractItemModelTester::layoutAboutToBeChanged()
{
    for (int i = 0; i < qBound(0, model->rowCount(), 100); ++i)
        changing.append(QPersistentModelIndex(model->index(i, 0)));
}

void AbstractItemModelTester::layoutChanged()
{
...
/*!
    ...
    \sa rowsRemoved()
 */
void AbstractItemModelTester::rowsAboutToBeRemoved(const QModelIndex &parent, int start, int end)
{
    Changing c;
    c.parent = parent;
    c.oldSize = model->rowCount(parent);
 ...
 */
void AbstractItemModelTester::rowsRemoved(const QModelIndex & parent, int start, int end)
{
