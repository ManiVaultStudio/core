...
const auto actionMetaTypeId = qRegisterMetaType<hdps::gui::ToggleAction*>("ToggleAction");
//const auto actionMetaTypeId = registerAction<hdps::gui::ToggleAction>("ToggleAction");
