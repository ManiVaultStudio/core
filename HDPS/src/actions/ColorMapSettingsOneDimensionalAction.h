 ...
 * @author Thomas Kroes
 */
class ColorMapSettingsOneDimensionalAction : public WidgetAction
{
    Q_OBJECT
...
public:
    ...
    public:
         ...
         * @param colorMapSettingsOneDimensionalAction Pointer to one-dimensional color map settings action
         */
        Widget(QWidget* parent, ColorMapSettingsOneDimensionalAction* colorMapSettingsOneDimensionalAction);
    };
...
protected:
     ...
     */
    ColorMapSettingsOneDimensionalAction(ColorMapAction& colorMapAction);
