...
HorizontalToolbarWidget::HorizontalToolbarWidget(QWidget* parent, ToolbarAction& toolbarAction) :
    ToolbarWidget(parent, toolbarAction, Qt::Horizontal),
    _mainLayout(),
    _toolbarLayout(),
    _toolbarWidget()
{
...
void HorizontalToolbarWidget::computeLayout(ToolbarItemWidget* ignoreToolbarItemWidget /*= nullptr*/)
{
    /*
