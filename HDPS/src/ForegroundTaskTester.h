...
Q_DECLARE_METATYPE(mv::ForegroundTaskTester)

inline const auto foregroundTaskTesterMetaTypeId = qRegisterMetaType<mv::ForegroundTaskTester*>("mv::ForegroundTaskTester");
