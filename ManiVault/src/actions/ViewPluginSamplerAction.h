 ...
 *
 * When the current sample context changes, the current ViewPluginSamplerAction#_viewGeneratorType
 * determines whether the HTML or widget view generator function is called to update the view:
 * - ViewPluginSamplerAction#_htmlViewGeneratorFunction, see ViewPluginSamplerAction::setHtmlViewGeneratorFunction(...)
 * - ViewPluginSamplerAction#_widgetViewGeneratorFunction, see ViewPluginSamplerAction::setWidgetViewGeneratorFunction(...)
 * The generated view is then either:
...
public:
     ...
     * @return View generator type
     */
    ViewGeneratorType getViewGeneratorType() const;

    /**
     * Set the generated view type to \p generatedViewType
     * @param viewGeneratorType View generator type
     */
    void setViewGeneratorType(const ViewGeneratorType& viewGeneratorType);

    /**
     * Sets the HTML view generator function to \p htmlViewGeneratorFunction (automatically sets the viewing type to ViewGeneratorType::HTML)
    ...
    /**
     * Sets the widget view generator function to \p widgetViewGeneratorFunction (automatically sets the viewing type to ViewGeneratorType::Widget)
...
signals:
    ...
    /**
     * Signals that the generated view type changed from \p previousViewGeneratorType to \p currentViewGeneratorType
     * @param previousViewGeneratorType Previous generated view type
     * @param currentViewGeneratorType Current generated view type
     */
