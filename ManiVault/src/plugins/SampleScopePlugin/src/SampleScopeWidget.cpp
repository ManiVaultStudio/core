...
SampleScopeWidget::SampleScopeWidget(SampleScopePlugin* sampleScopePlugin, QWidget* parent /*= nullptr*/) :
    ...
    _noSamplesOverlayWidget(&_textScrollArea, Application::getIconFont("FontAwesome").getIcon("eye-dropper"), "No samples", "There are currently no samples available for viewing...")
{
