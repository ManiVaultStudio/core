 ...
 * @endcode
 */
class CORE_EXPORT VariantMapWorkflowContext final : public WorkflowContextBase
{
public:
...
using UniqueVariantMapWorkflowContext = std::unique_ptr<VariantMapWorkflowContext>;
using SharedVariantMapWorkflowContext = std::shared_ptr<VariantMapWorkflowContext>;
