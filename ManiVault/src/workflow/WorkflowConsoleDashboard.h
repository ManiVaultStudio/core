...
/**
 * @brief Renders live workflow progress in the console.
 *
...
public:
    ...
    /**
     * @brief Constructs a console dashboard.
     * @param state Shared workflow execution state to observe.
     */
    explicit WorkflowConsoleDashboard(WorkflowExecutionState::Ptr state);

    /**
     * @brief Stops the dashboard thread.
     */
    ~WorkflowConsoleDashboard();

    /**
     * @brief Starts periodic console rendering.
     */
    void start();

    /**
     * @brief Stops periodic rendering.
     */
    void stop();

    /**
     * @brief Renders the current workflow progress tree.
     */
    void render() const;
