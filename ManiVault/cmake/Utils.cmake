function(mv_set_version)
    ...
    set(MV_VERSION "${VERSION_NUMERIC}" CACHE INTERNAL "ManiVault: MV_VERSION")
    set(MV_VERSION_FULL "${VERSION_NUMERIC}" CACHE INTERNAL "ManiVault: MV_VERSION_FULL")
    
    # Only use suffix in version variable if non-empty
    if(NOT "${MV_VERSION_SUFFIX}" STREQUAL "")
        set(MV_VERSION_FULL "${VERSION_NUMERIC}${MV_VERSION_SUFFIX}" CACHE INTERNAL "ManiVault: MV_VERSION_FULL")
    endif()

    # Calculate the length of the string
    string(LENGTH "${MV_VERSION_SUFFIX}" PROJECT_VERSION_SUFFIX_LENGTH)
    set(PROJECT_VERSION_SUFFIX_LENGTH "${PROJECT_VERSION_SUFFIX_LENGTH}" CACHE INTERNAL "ManiVault: PROJECT_VERSION_SUFFIX_LENGTH")
    ...
    set(PROJECT_VERSION_SUFFIX "${VERSION_SUFFIX_ELEMENTS}" CACHE INTERNAL "ManiVault: PROJECT_VERSION_SUFFIX")
